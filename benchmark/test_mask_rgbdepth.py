...
def main():
    ...
    # mask
    # cramed
    weights_tmdc_nv = "/root/autodl-tmp/data/results/nvgesture_tmdc/NVGesture_best_second_stage_acc0.5695020746887967_epochs100_epoch75.pth"
    test_scenarios_tmdc_nv = {
        "TMDC_rgb0.0_depth0.0_both": (0.0, 0.0, 'both', "TMDC", weights_tmdc_nv, 'Mask'),
        "TMDC_rgb0.0_depth0.0_depth": (0.0, 0.0, 'depth', "TMDC", weights_tmdc_nv, 'Mask'),
        "TMDC_rgb0.0_depth0.0_rgb": (0.0, 0.0, 'rgb', "TMDC", weights_tmdc_nv, 'Mask'),
        "TMDC_rgb0.1_depth0.1_both": (0.1, 0.1, 'both', "TMDC", weights_tmdc_nv, 'Mask'),
        "TMDC_rgb0.1_depth0.1_depth": (0.1, 0.1, 'depth', "TMDC", weights_tmdc_nv, 'Mask'),
        "TMDC_rgb0.1_depth0.1_rgb": (0.1, 0.1, 'rgb', "TMDC", weights_tmdc_nv, 'Mask'),
        "TMDC_rgb0.5_depth0.5_both": (0.5, 0.5, 'both', "TMDC", weights_tmdc_nv, 'Mask'),
        "TMDC_rgb0.5_depth0.5_depth": (0.5, 0.5, 'depth', "TMDC", weights_tmdc_nv, 'Mask'),
        "TMDC_rgb0.5_depth0.5_rgb": (0.5, 0.5, 'rgb', "TMDC", weights_tmdc_nv, 'Mask'),
        "TMDC_rgb0.1_depth0.5_both": (0.1, 0.5, 'both', "TMDC", weights_tmdc_nv, 'Mask'),
        "TMDC_rgb0.5_depth0.1_both": (0.5, 0.1, 'both', "TMDC", weights_tmdc_nv, 'Mask'),
        "TMDC_rgb0.1_depth0.3_both": (0.1, 0.3, 'both', "TMDC", weights_tmdc_nv, 'Mask'),
        "TMDC_rgb0.3_depth0.1_both": (0.3, 0.1, 'both', "TMDC", weights_tmdc_nv, 'Mask'),
        "TMDC_rgb0.3_depth0.7_both": (0.3, 0.7, 'both', "TMDC", weights_tmdc_nv, 'Mask'),
        "TMDC_rgb0.7_depth0.3_both": (0.7, 0.3, 'both', "TMDC", weights_tmdc_nv, 'Mask'),
    }


    # mask
    # cramed
    weights_t2dr_nv = "/root/autodl-tmp/data/results/nvgesture_t2dr/final_best_model_NVGesture_epoch96_acc0.4398.pth"
    test_scenarios_t2dr_nv = {
        "T2DR_rgb0.0_depth0.0_both": (0.0, 0.0, 'both', "T2DR", weights_t2dr_nv, 'Mask'),
        "T2DR_rgb0.0_depth0.0_depth": (0.0, 0.0, 'depth', "T2DR", weights_t2dr_nv, 'Mask'),
        "T2DR_rgb0.0_depth0.0_rgb": (0.0, 0.0, 'rgb', "T2DR", weights_t2dr_nv, 'Mask'),
        "T2DR_rgb0.1_depth0.1_both": (0.1, 0.1, 'both', "T2DR", weights_t2dr_nv, 'Mask'),
        "T2DR_rgb0.1_depth0.1_depth": (0.1, 0.1, 'depth', "T2DR", weights_t2dr_nv, 'Mask'),
        "T2DR_rgb0.1_depth0.1_rgb": (0.1, 0.1, 'rgb', "T2DR", weights_t2dr_nv, 'Mask'),
        "T2DR_rgb0.5_depth0.5_both": (0.5, 0.5, 'both', "T2DR", weights_t2dr_nv, 'Mask'),
        "T2DR_rgb0.5_depth0.5_depth": (0.5, 0.5, 'depth', "T2DR", weights_t2dr_nv, 'Mask'),
        "T2DR_rgb0.5_depth0.5_rgb": (0.5, 0.5, 'rgb', "T2DR", weights_t2dr_nv, 'Mask'),
        "T2DR_rgb0.1_depth0.5_both": (0.1, 0.5, 'both', "T2DR", weights_t2dr_nv, 'Mask'),
        "T2DR_rgb0.5_depth0.1_both": (0.5, 0.1, 'both', "T2DR", weights_t2dr_nv, 'Mask'),
        "T2DR_rgb0.1_depth0.3_both": (0.1, 0.3, 'both', "T2DR", weights_t2dr_nv, 'Mask'),
        "T2DR_rgb0.3_depth0.1_both": (0.3, 0.1, 'both', "T2DR", weights_t2dr_nv, 'Mask'),
        "T2DR_rgb0.3_depth0.7_both": (0.3, 0.7, 'both', "T2DR", weights_t2dr_nv, 'Mask'),
        "T2DR_rgb0.7_depth0.3_both": (0.7, 0.3, 'both', "T2DR", weights_t2dr_nv, 'Mask'),
    }
    
    
    test_scenarios = test_scenarios_tmdc_nv
