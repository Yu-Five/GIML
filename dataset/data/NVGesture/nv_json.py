...
if __name__ == '__main__':
    ...
    for class_type in ['all_but_None']:
...
# python /root/autodl-tmp/daima/used/General_IML/dataset/data/NVGesture/nv_json.py 'annotation_nvGesture' all


# python /root/autodl-tmp/daima/used/General_IML/dataset/data/NVGesture/nv_json.py 'annotation_nvGesture' all_but_None
