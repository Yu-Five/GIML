"""
Docstring for dataset.data.NVGesture.readdata
下面的代码来自
...
dataset_path = "/root/autodl-tmp/data/NVGesture/data"
def load_split_nvgesture(file_with_split = '/root/autodl-tmp/data/NVGesture/data/nvgesture_train_correct.lst',list_split = list()):
...
if __name__ == "__main__":
    ...
    file_lists = dict()
    if subset == 'training':
        file_list = "/root/autodl-tmp/data/NVGesture/data/nvgesture_train_correct_cvpr2016_v2.lst"
    elif subset == 'validation':
        file_list = "/root/autodl-tmp/data/NVGesture/data/nvgesture_test_correct_cvpr2016_v2.lst"
...
# python /root/autodl-tmp/daima/used/General_IML/dataset/data/NVGesture/readdata.py training trainlistall.txt all 【√】

# python /root/autodl-tmp/daima/used/General_IML/dataset/data/NVGesture/readdata.py validation vallistall.txt all 【√】


# python /root/autodl-tmp/daima/used/General_IML/dataset/data/NVGesture/readdata.py training trainlistall_but_None.txt all_but_None


# python /root/autodl-tmp/daima/used/General_IML/dataset/data/NVGesture/readdata.py validation vallistall_but_None.txt all_but_None
